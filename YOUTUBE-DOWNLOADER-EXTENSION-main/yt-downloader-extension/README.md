...
#### Option A: One-Click Background Mode (Recommended for Windows)
Just run **`ENABLE_AUTO_START.bat`**. This will:
- Start the server in the background (no window).
- Add it to your Windows Startup folder so it works every time you turn on your PC.

#### Option B: Manual Mode (Terminal)
